      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-12">
        <div className="grid gap-10 md:grid-cols-3">
          ...
          <div className="space-y-2 text-sm">
            ...
            <Link href="#" className="block text-muted hover:text-foreground transition-colors">
        ...
        <div className="mt-10 flex flex-col gap-3 border-t border-white/10 pt-6 text-xs text-muted sm:flex-row sm:items-center sm:justify-between">
